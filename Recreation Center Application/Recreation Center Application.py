...
class RecreationCenterApplication:
    ...
    def landRental(self):
        ...
        tk.Label(page, text='$15').grid(row=2, column=2, sticky=tk.W)

        # Sleeping Bag
        tk.Label(page, text='Sleeping Bag', font=('Arial', 14)).grid(row=3, column=0, sticky=tk.W)
        ...
        tk.Label(page, text='$8').grid(row=3, column=2, sticky=tk.W)

        # Backpack
        tk.Label(page, text='Backpack', font=('Arial', 14)).grid(row=4, column=0, sticky=tk.W)
        ...
        tk.Label(page, text='$10').grid(row=4, column=2, sticky=tk.W)

        tk.Label(page, text='Accessories', font=('Arial', 14, 'bold')).grid(row=5, column=0, sticky=tk.W)

        # 2 Burner Stove
        tk.Label(page, text='2 Burner Stove', font=('Arial', 14)).grid(row=6, column=0, sticky=tk.W)
        ...
        tk.Label(page, text='$10').grid(row=6, column=2, sticky=tk.W)

        # Lantern
        tk.Label(page, text='Lantern', font=('Arial', 14)).grid(row=7, column=0, sticky=tk.W)
        ...
        tk.Label(page, text='$5').grid(row=7, column=2, sticky=tk.W)

        # Cook Pot Set
        tk.Label(page, text='Cook Pot Set', font=('Arial', 14)).grid(row=8, column=0, sticky=tk.W)
        ...
        tk.Label(page, text='$5').grid(row=8, column=2, sticky=tk.W)

        # Water Cooler
        tk.Label(page, text='Water Cooler', font=('Arial', 14)).grid(row=9, column=0, sticky=tk.W)
        ...
        tk.Label(page, text='$5').grid(row=9, column=2, sticky=tk.W)

        # Hammock
        tk.Label(page, text='Hammock', font=('Arial', 14)).grid(row=10, column=0, sticky=tk.W)
        ...
        tk.Label(page, text='$8').grid(row=10, column=2, sticky=tk.W)

        self.calcTotal = lambda: self.calculateLandCost(self.tent_var.get(), self.sleepingbag_var.get(), self.backpack_var.get(), self.twoburnerstove_var.get(), self.lantern_var.get(), self.cookpotset_var.get(), self.watercooler_var.get(), self.hammock_var.get())
        tk.Button(page, text='Calculate', command=self.calcTotal).grid(row=11, column=2)
    ...
    def waterRental(self):
        page = tk.Frame(self.master)
        page.grid()
        tk.Label(page, text='Water Rentals', font=('Arial', 14, 'bold')).grid(row=0)
        tk.Button(page, text='Back', command=self.goto_page1).grid(row=11)
        tk.Button(page, text='Next Page', command=self.goto_page3).grid(row=11, column=1)

        # Canoe
        tk.Label(page, text='Canoe', font=('Arial', 14)).grid(row=2, column=0, sticky=tk.W)
        self.canoe_var = tk.IntVar()
        ttk.Combobox(page, textvariable=self.canoe_var, values=[0,1,2,3,4,5]).grid(row=2, column=1, sticky=tk.W)
        tk.Label(page, text='$25').grid(row=2, column=2, sticky=tk.W)

        # Kayak
        tk.Label(page, text='Kayak', font=('Arial', 14)).grid(row=3, column=0, sticky=tk.W)
        self.kayak_var = tk.IntVar()
        ttk.Combobox(page, textvariable=self.kayak_var, values=[0,1,2,3,4,5]).grid(row=3, column=1, sticky=tk.W)
        tk.Label(page, text='$15').grid(row=3, column=2, sticky=tk.W)

        # Paddle Board
        tk.Label(page, text='Paddle Board', font=('Arial', 14)).grid(row=4, column=0, sticky=tk.W)
        ...
        tk.Label(page, text='$20').grid(row=4, column=2, sticky=tk.W)

        tk.Label(page, text='Accessories', font=('Arial', 14, 'bold')).grid(row=5, column=0, sticky=tk.W)

        # PFD
        tk.Label(page, text='PFD', font=('Arial', 14)).grid(row=6, column=0, sticky=tk.W)
        self.pfd_var = tk.IntVar()
        ttk.Combobox(page, textvariable=self.pfd_var, values=[0,1,2,3,4,5]).grid(row=6, column=1, sticky=tk.W)
        tk.Label(page, text='$5').grid(row=6, column=2, sticky=tk.W)

        # Paddles
        tk.Label(page, text='Paddles', font=('Arial', 14)).grid(row=7, column=0, sticky=tk.W)
        ...
        # Dry Bag
        tk.Label(page, text='Dry Bag', font=('Arial', 14)).grid(row=8, column=0, sticky=tk.W)
        ...
        # Dry Pack
        tk.Label(page, text='Dry Pack', font=('Arial', 14)).grid(row=9, column=0, sticky=tk.W)
        ...
        tk.Label(page, text='$10').grid(row=9, column=2, sticky=tk.W)
    ...
    def transactionSummaryPage(self):
        page = tk.Frame(self.master)
        page.grid()
        tk.Label(page, text='Transaction Summary', font=('Arial', 14, 'bold')).grid(row=0)
